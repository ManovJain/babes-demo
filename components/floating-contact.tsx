...
const HIDDEN_PATHS = ["/booking", "/contact"]
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <button
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#0088cc] shadow-lg transition-transform hover:scale-110"
        aria-label="Book via Telegram"
        title="Book via Telegram"
      >
